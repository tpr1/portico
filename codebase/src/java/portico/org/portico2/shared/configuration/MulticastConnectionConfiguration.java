...
import org.portico2.shared.network.NetworkUtils;

public class MulticastConnectionConfiguration extends ConnectionConfiguration
{
	//----------------------------------------------------------
	//                    STATIC VARIABLES
	//----------------------------------------------------------
	...
	//                      CONSTRUCTORS
	//----------------------------------------------------------
	public MulticastConnectionConfiguration( String name )
	{
		super( name );
