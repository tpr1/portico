...
import org.portico2.shared.logging.Log4jConfiguration;
import org.portico2.shared.utils.FileUtils;
...
public class RID
{
		...
		throws JConfigurationException
	{
		...
		// 3. Parse the property sets into this RID
		parseProperties( ridproperties );
		parseProperties( clproperties );
		
		// 4. Store the unified properties
