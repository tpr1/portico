...
/**
 * Message representing the request to cancel an attribute divestiture.
 */
public class CancelDivest extends PorticoMessage
{
	//----------------------------------------------------------
	//                    STATIC VARIABLES
	//----------------------------------------------------------
	...
	//                      CONSTRUCTORS
	//----------------------------------------------------------
	public CancelDivest( int objectHandle, Set<Integer> attributes )
	{
		super();
	...
	{
		return MessageType.CancelDivest;
	}
