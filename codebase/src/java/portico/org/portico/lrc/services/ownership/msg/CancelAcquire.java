 ...
 * <p/>
 * This message has the <code>isImmediateProcessingRequired()</code> flag set to true.
 */
public class CancelAcquire extends PorticoMessage
{
	//----------------------------------------------------------
	//                    STATIC VARIABLES
	//----------------------------------------------------------
	...
	//                      CONSTRUCTORS
	//----------------------------------------------------------
	public CancelAcquire( int objectHandle, Set<Integer> attributes )
	{
		super();
